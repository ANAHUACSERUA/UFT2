CREATE OR REPLACE PACKAGE BANINST1.pk_Salida_Rep_Moro_3 IS
/******************************************************************************
PAQUETE:            BANINST1.pk_Salida_Rep_Moro_3
OBJETIVO:           Contiene los procedimientos, funciones y variables
                    requeridos para la generación de archivos pk_Salida_Rep_Moro_3
...
PROCEDURE p_Genera(
 ...
 ,pdFecha1 in date default sysdate
);
