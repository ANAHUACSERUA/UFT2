CREATE OR REPLACE PACKAGE BODY BANINST1.KWACRGA IS
...
*/
  ...
  begin
      ...
      'function cicloTerminado(){
         ...
         document.getElementById("fraProceso").className = "tamW1"
           ...
           document.getElementById("fraProceso").src       = "KWACRGA.proceso";
  ...
  begin
     ...
     -->
      ...
      <iframe name="fraProceso" id="fraProceso" src="KWACRGA.proceso" class="tamW1" frameborder="0" tabindex="-1" scrolling="no">
      </iframe>
      ...
      <form name="frmInserta" id="frmInserta" onSubmit="false" method="post" target="fraInserta" action="KWACRGA.inserta">

         <input type="hidden" name="pnSecuencia" id="pnSecuencia" value=+psText>
      </form>


      <form name="frmProceso" id="frmProceso" onSubmit="false" method="post" target="fraInserta" action="KWACRGA.proceso">
  ...
  <!--aaca mando ejecutar el proceso bitacora y el campo p_nombre_file es su parametro que al nicio va vacio-->
    ...
    <form name="frmbitacora" id="frmbitacora" onSubmit="false" method="post" target="_self" action="KWACRGA.Bitacora">
      ...
      <tr>
          ...
          <td class="etiqueta" valign="left" >
              <select name="psAplicacion" style="width:300px" id="psAplicacion">
                     ...
                     <OPTION VALUE="loadQ">Carga ADICIONAL DEMRE</OPTION>
              </select>
           </td>
          </tr>
        <tr>
...
begin
   ...
   ---IF Pk_Login.F_ValidacionDeAcceso(pk_login.vgsUSR) THEN RETURN; END IF;
    ...
    --- vmensajerr  := 'PROBLEMAS AL CARGAR EL ARCHIVO PUEDE QUE ESTE DUPLICADO';
     ...
     vsNameArchivo := recorta(p_nombre_file);
      ...
      ------curosr  de tipo del archivo    md-01 start
  ...
  --- insert into swrpaso values ('bitacora DATOS2  ', varpaso );  commit;
     ...
     htp.p(' <P> <A HREF="KWACRGA.Inicio"> REGRESA MENU </A> </p>
             </center>
             </body>
             </html> ');
