CREATE OR REPLACE PACKAGE BODY BANINST1.pk_CargaCaeFianzaOfIngresaNv IS
...
--------------------------------------------
modificacion        md-03
objetivo            se modifica el metodo de carga del archivo
autor               roman ruiz
fecha               27-ene-2016
******************************************************************************/
...
END pk_CargaCaeFianzaOfIngresaNv;
/
