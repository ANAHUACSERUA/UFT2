CREATE OR REPLACE PACKAGE BANINST1.pk_ContratoCFC IS
/******************************************************************************
...
PROCEDURE p_ContratoIndividual(psCntr VARCHAR2);

PROCEDURE p_Contrato_firma_ebustos_2014(psCntr VARCHAR2);
PROCEDURE p_ContratoDiplomado(psCntr VARCHAR2);
/******************************************************************************
...
FUNCTION f_get_mes(psMes VARCHAR2) return VARCHAR2;

function f_porcomprometer  (pspidm  number, psntran number) RETURN NUMBER ;
