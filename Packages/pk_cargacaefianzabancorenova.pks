CREATE OR REPLACE PACKAGE BANINST1.pk_CargaCaeFianzaBancoRenova IS
/******************************************************************************
PAQUETE:            BANINST1.pk_CargaCaeFianzaBancoRenova
OBJETIVO:           Contiene los procedimientos, funciones y variables
                    requeridos para la carga de archivos de fianzas Bancos
AUTOR:              Roman Ruiz
FECHA:              22 oct 2014
******************************************************************************/
...
END pk_CargaCaeFianzaBancoRenova;
/